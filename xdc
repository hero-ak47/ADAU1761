...
## Switches
set_property -dict {PACKAGE_PIN E22 IOSTANDARD LVCMOS12} [get_ports reset]
...
## Audio Codec
set_property -dict {PACKAGE_PIN T4 IOSTANDARD LVCMOS33} [get_ports adau1761_adc_sdata]
set_property -dict {PACKAGE_PIN T5 IOSTANDARD LVCMOS33} [get_ports adau1761_bclk]
set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVCMOS33} [get_ports adau1761_dac_sdata]
set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports adau1761_lrclk]
set_property -dict {PACKAGE_PIN U6 IOSTANDARD LVCMOS33} [get_ports adau1761_mclk]


## Pmod header JA
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports check_adc]
set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { check_bclk }]; #IO_L10P_T1_D14_14 Sch=ja[2]
set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { check_lrclk }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
...
set_property PACKAGE_PIN W5 [get_ports iic_scl_io]
set_property PACKAGE_PIN V5 [get_ports iic_sda_io]
